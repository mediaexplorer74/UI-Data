...
public abstract class ReadOnlyItemsBundle<TOut>
{
    internal abstract IUpdateReadOnlyCollection<TOut?> ReadOnlyOutputContent { get; }
}
public abstract class ReadOnlyItemsBundleBase<TIn, TOut> : ReadOnlyItemsBundle<TOut>
{
    ...
    internal override IUpdateReadOnlyCollection<TOut> ReadOnlyOutputContent => dest;
...
public class ReadOnlyItemsBundleProcessor<TIn1, TIn2, TOut>
{
    ...
    public ReadOnlyItemsBundleProcessor(IReadOnlyBinding<ReadOnlyItemsBundle<TIn1, TIn2, TOut>> prop, DataTemplateDefinition<TIn1, TIn2> innerTemplate)
    {
        ...
        FinalTemplate = new()
        {
            ItemsSource = ItemsBundle2.ReadOnlyOutputContent
        };
